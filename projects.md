...
Generated from public GitHub repository metadata at 2026-05-25 23:07 UTC.

| Project | Description | Lang | Stars | Updated |
|---|---|---:|---:|---:|
| [deeper](https://github.com/xodn348/deeper) | Depth-first interview agent driven by Huntley's ralph + feedback loops. Drills one claim to bedrock (first principle / source of truth); never expands. Per-round fresh subagent dispatch + path-bias self-improvement. | Shell | 0 | 2026-05-25 |
...
| [ai-news-radar](https://github.com/xodn348/ai-news-radar) | 📡 AI 소식, 어디서 가장 먼저 터지는가? — 속도 순으로 정렬한 AI 뉴스 소스 큐레이션 (X · Reddit · 뉴스레터 · 논문 · YouTube) | Python | 0 | 2026-05-02 |
| [destiny](https://github.com/xodn348/destiny) | Daily fortune-telling plugin for Claude Code. | Python | 63 | 2026-05-01 |
